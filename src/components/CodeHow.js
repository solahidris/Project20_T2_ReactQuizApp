const CodeHow = () => {
  return (
    <div className="bg-stone-100/20 p-5 lg:mx-[30%] rounded-lg mt-5 text-xs">
      ...
      <h5>3) Since data is small, just use array for data set</h5>
      <h5>4) Code the components out and map array</h5>
      <h5>5) Use chat gpt for qna data</h5>
      <h5>6) Make try again to reset game</h5>
      <h5>7) Code complete</h5>
    </div>
  );
};
